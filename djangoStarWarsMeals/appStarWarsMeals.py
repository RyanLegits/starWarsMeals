...
class Character:
    def __init__(self, name, homeworldName, planet):
        self.name = name
    ...
    def dish(self):
        ...
        for i in self.planet.climate.strip(",").split(" "):
...
for person in people.iter():
    ...
    characterList.append(Character(person.name, characterHomeworld, dataPlanet))
